...
public class Pagerank {
    ...
    String pagerankFile = BASE_RESOURCES.resolve("java-processed/pagerank-scores.txt").toString();
    ...
    public void pagerank() {
        int k = 300;
        int totalNumberOfPages = BuildCorpus.calculatePageNumber(corpusPath);
        try {
            FileReader fileReader = new FileReader(matrixCLIPath, StandardCharsets.UTF_8);
            BufferedReader bufferedReader = new BufferedReader(fileReader);

            ProgressLogger logger = new ProgressLogger("PAGERANK ITERATIONS", "Iterations");
